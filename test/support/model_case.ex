defmodule OpenmaizePhoenixBoilerplate.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import OpenmaizePhoenixBoilerplate.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&OpenmaizePhoenixBoilerplate.ErrorHelpers.translate_error/1)
